	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> <span class="little_n">
					| <a href="../main/booklist.action" name="mydangdang" class="head_black12a">我的当当</a> | <a
		...
		<b>您好，欢迎光临当当网</b>
		[&nbsp;<a href="../user/login.action" class="b">登出</a>&nbsp;]
		[&nbsp;<a href="../user/login.action" class="b">登录</a>|<a
			href="../user/regist.action" class="b">注册</a>&nbsp;]
		</span>
	</div>
	<div class="head_head_list">
		<div class="head_head_list_left">
			<span class="head_logo"><a href="main.action" name="backtobook"><img
